...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <button className='hidden lg:flex flex-col items-center justify-center' onClick={handleClick}>
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className='flex items-center justify-center flex-wrap mt-2'>
          <motion.a href={'https://twitter.com/Tausur_Rahaman'} target='_blank'
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a href={'https://github.com/TausurRahaman'} target='_blank'
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a href={'https://www.linkedin.com/in/tausur-rahaman-a66ba028a/'} target='_blank'
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className='w-6 mx-3'
          >
          ...
          <motion.a href={'https://dribbble.com/tausurrahaman'} target='_blank'
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className='w-6 ml-3'
          >
